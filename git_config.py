...
class Remote(object):
  ...
  def __init__(self, config, name):
    ...
    if self.projectname is not None:
      print('DEBUG RemoteKey is ' + self.projectname)
      print('Type' + str(type(self._Get('projectreview_name'))))
  ...
  def _Get(self, key, all_keys=False):
    ...
    if self._config.GetString(key, all_keys=all_keys) is not None:
      print('DEBUG REMOTE ' + key + " val " + str(self._config.GetString(key, all_keys=all_keys)))
